...
<link href="style.css" rel="stylesheet" type="text/css">
 ...
 <table width="100%" align="center" cellpadding="0" cellspacing="0" style="margin:0; border-bottom:3px solid #E8BA33; margin-top:-21px; padding:0; z-index:1000000; position:fixed; background:#FFFFFF;"> 
...
display:block; 
 ...
 <table width="744" style="position:relative;  z-index:0; top:34px;"  align="center">

<tr>

<td width="744" align="center" bgcolor="#FFFFFF" style="" id="linkebi"> 

<div id="menu" style="position:fixed; margin-left:-114px; top:68px;" align="left">
    ...
    <li><a href="index.php?do=authors">ავტორები</a> </li>
      ...
      <ul class="niveau2">
        ...
        <li><a href="index.php?do=enghome">English</a></li> 
             ...
             <li><a href="http://www.tbilisilitfest.ge/squirrelmail/src/login.php/" target="_blank">ელფოსტა</a></li>
...
<td valign="top" style="width:170px; max-width:170px; padding-right:15px;">
...
.cover4:hover  { transform: scale(1.0) ;  /* rotate(2.1deg) */ 
 ...
 <img src="../<? echo $b['upload']; ?>" class="cover4" id="im4" align="left">  
