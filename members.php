...
<section id="main-container">
	<div class="container">
		...
		<div class="row" align="center" style="position: relative; top: -150px;">
			<div class="col-md-9" align="center">       
			 <?
$a=mysqli_query($conn,"select * from kultura_cxrili WHERE kategory='ჩვენი წევრები და მეგობრები' AND hidden='0' order by id desc limit 1");
