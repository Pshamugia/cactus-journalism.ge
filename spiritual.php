...
<section id="main-container">
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE kategory='სულიერი მიმართულებით' AND hidden='0'";
	$total_pages = mysqli_fetch_array(mysqli_query($conn, $query));
	$total_pages = $total_pages['num'];
	
	/* Setup vars for query. */
	$targetpage = "index.php?do=spiritual"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM $tbl_name WHERE kategory='სულიერი მიმართულებით' AND hidden='0' order by news_date desc LIMIT $start, $limit";
