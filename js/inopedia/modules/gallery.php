...
<?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where kategory='ფოტო' and eng_geo='Geo'";
	...
	$sql = "SELECT * FROM $tbl_name where kategory='ფოტო' and eng_geo='Geo' order by id desc LIMIT $start, $limit";
...
<a href="index.php?do=updatephoto&id=<? echo $b['id']; ?>"><img src="images/edit-icon.png" width="20" 
